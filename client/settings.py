...
USERNAME = f"Host_{sys.argv[-1]}"

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('GHARAR_CLIENT_SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True if os.environ.get('GHARAR_CLIENT_DEBUG').lower() not in ['false', 'f', '0'] else True

ALLOWED_HOSTS = os.environ.get('GHARAR_CLIENT_ALLOWED_HOSTS').split(';')
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / f"db_{sys.argv[-1]}.sqlite3",
    }
}
